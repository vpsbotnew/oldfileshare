...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002275800146"))
...
#Force sub message 
FORCE_MSG = os.environ.get("FORCE_SUB_MESSAGE", "Hello ‼️{first}\n\n<b>♦️ရုပ်ရှင်ရရှိဖို့အတွက် [✅Join Channel] ကိုနှိပ်ပြီးချန်နယ်လေးကို အရင် Join ပေးပါနော်။😊\n\n♦️Firstly, Click to [✅Join Channel]😇\n\n♦️ချန်နယ် Join ပြီးတာနဲ့ [🔐Try Again] ကိုနှိပ်ပြီးဇာတ်ကားရယူနိုင်ပါပြီ။</b>")
